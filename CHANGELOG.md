...
- **`docs/USER_MANUAL.md`**: ユーザマニュアルを新規作成（Mermaid フロー図付き）
  - 全キーボードショートカット一覧、プラグインメニュー操作、ピアノロールマクロ
  - VST ショートカット、プロジェクト時間トラッキング、メニューバー操作
  - 全設定リファレンス（デフォルト値・型・説明）、トラブルシューティング
